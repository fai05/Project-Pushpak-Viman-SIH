...
Usage:
  ...
  # Create train data:
  python generate_tfrecord.py --csv_input=victim_data/train_labels.csv --image_dir=victim_data/train --output_path=train.record

  # Create test data:
  python generate_tfrecord.py --csv_input=victim_data/test_labels.csv  --image_dir=victim_data/test --output_path=test.record
"""
